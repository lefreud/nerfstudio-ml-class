...
from hdr_nerf.hdr_nerf_field import HdrNerfField
...
@dataclass
class HdrNerfModelConfig(ModelConfig):
    """Nerfacto Model Config"""

    _target: Type = field(default_factory=lambda: HdrNerfModel)
